...
import eu.europeana.ld.analysis.LangDistributionStat;
import eu.europeana.ld.analysis.LangStat;
...
public class MultiVocConceptAnalysis {
    ...
    public void analyse(File dest) throws IOException
    {
        ...
        stats.add(new DBPediaAnalysis(DBPediaConceptAnalysis.SRCLIST)
                    .analyse(DBPediaConceptAnalysis.SRC));
        stats.add(new FreebaseAnalysis(FreebaseConceptAnalysis.SRCLIST)
                    .analyse(FreebaseConceptAnalysis.SRC));
        stats.add(new BabelNetAnalysis(BabelNetConceptAnalysis.SRCLIST)
                    .analyse(BabelNetConceptAnalysis.SRC));
        stats.add(new LexvoAnalysis(LexvoConceptAnalysis.SRCLIST)
                    .analyse(LexvoConceptAnalysis.SRC));
        stats.add(new EurovocAnalysis(EurovocConceptAnalysis.SRCLIST)
                    .analyse(EurovocConceptAnalysis.SRC));
