 ...
 * @since 23 Jun 2016
 */
public class WikidataImagesHarvesterSingle
{
  //private String _query    = "SELECT ?image WHERE { ?obj wdt:P109 ?image }";
    private String _query    = "SELECT ?image WHERE { ?obj wdt:P18 ?image }";
    private String _endpoint = SPARQL_WIKIDATA;

    public WikidataImagesHarvesterSingle() {}
    ...
    private String fetchImage(String uri)
    {
        ...
        QueryEngineHTTP endpoint
            = new QueryEngineHTTP(_endpoint, query);
        try {
