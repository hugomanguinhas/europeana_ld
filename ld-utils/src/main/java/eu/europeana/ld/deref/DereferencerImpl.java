...
public class DereferencerImpl implements Dereferencer
{
    ...
    public DereferencerImpl(String defaultMime) { _defaultMime = defaultMime; }

    public DereferencerImpl() { this(Lang.RDFXML.getContentType().toString()); }
    ...
    public Model dereference(String url) throws IOException
    {
