 ...
 * @since 10 Sep 2015
 */
public class RDF2SKOSExtractor implements SKOSExtractor<Model>
{
    ...
    public RDF2SKOSExtractor(String base, Property... props)
    {
        _props = props;
        _base  = base;
    }

    public RDF2SKOSExtractor(String base) { this(base, PROPERTIES); }
