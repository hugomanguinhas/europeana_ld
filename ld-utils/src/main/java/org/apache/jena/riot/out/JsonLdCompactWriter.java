...
public class JsonLdCompactWriter
{
    private Object        _context   = null; 
    private JsonLdOptions _jsonldOpt = null;

    public JsonLdCompactWriter(String contextURL) { this((Object)contextURL); }

    public JsonLdCompactWriter(URL contextURL) { this(contextURL.toString()); }

    public JsonLdCompactWriter(Map context)    { this((Object)context); }

    private JsonLdCompactWriter(Object context)
    { 
        _context = context;
